 ...
 */
@Slf4j
public class MySQLStorageBackend implements IConfigurationStorageBackend {
     ...
     */
    public MySQLStorageBackend(String connectionString, String username, String password, String databaseName, String tableName) {
        ...
        try {
            ...
            Liquibase liquibase = new Liquibase("mysql-changelog.xml", new ClassLoaderResourceAccessor(), database);
    ...
    public void storeConfiguration(String environment, String name, ConfigurationEntry config) {
        try {
            ...
            // write query
            PreparedStatement stmt = dataSource.getConnection().prepareStatement("REPLACE INTO " + this.tableName + " (environment, name, content) VALUES (?, ?, ?)");
